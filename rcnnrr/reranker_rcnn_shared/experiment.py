...
import rcnnrr.reranker_rcnn_shared.data_reader as data_reader
import rcnnrr.reranker_rcnn_shared.data_writer as data_writer
from rcnnrr.data.dataset import Dataset, SimpleBatch
from rcnnrr.reranker_rcnn_shared.data_converter import DataConverter
from rcnnrr.reranker_rcnn_shared.data_loader import DataLoader
from rcnnrr.reranker_rcnn_shared.evaluator import Stats
from rcnnrr.reranker_rcnn_shared.network import RCNNReranker
...
class Experiment(object):
    ...
    def __down_sample(self, batch):
        ...
        for n, labels in zip(ns, batch[11]):
            ids = list(range(n))
            random.shuffle(ids)
...
if __name__ == '__main__':
    ...
    group.add_argument('--lstm_hidden_dim', type=int, default=100,
    ...
    group.add_argument('--char_output_dropout', type=float, default=0.33,
